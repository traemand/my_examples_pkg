...
# 1) Terminal 1: run the file (python or rosrun)
# 2) Terminal 2: echo the result from the action server (rostopic echo /move_drone_square_as/result)
# 3) Terminal 3: echo the feedback from the action server (rostopic echo /move_drone_square_as/feedback)
# 4) Terminal 4: publish the goal message to the topic (rostopic pub /move_drone_square_as/goal actionlib/TestActionGoal [TAB] [TAB]) 
#     - remember to set the desired time for the sides in "nseconds" in the message
